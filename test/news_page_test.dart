...
void main(){
  ...
  testWidgets("tittle is displayed", (WidgetTester tester)async{
  ...
  testWidgets('Loading indicator is displayed while waiting for articles', (WidgetTester tester)async{
    ...
    await tester.pumpWidget(createWidgetUnderTest());
    await tester.pump(const Duration(milliseconds: 500)); // This forces a widget to rebuild

    expect(find.byType(CircularProgressIndicator), findsOneWidget);

    await tester.pumpAndSettle(); //This waits until there are no more rebuilds happening eg animations like CircularProgressIndicator
  });
